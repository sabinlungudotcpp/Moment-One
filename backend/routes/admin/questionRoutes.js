...
questionRouter.route('/').get(questionController.getAllQuestions).post(questionController.checkBody, questionController.createQuestion).delete(questionController.deleteQuestions);
